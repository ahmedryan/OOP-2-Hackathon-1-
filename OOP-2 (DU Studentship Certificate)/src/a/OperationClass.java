...
public class OperationClass {
	...
	{	
		...
		else
		{
			...
			frc.ArrStu.get(index).acinfo.setCgpa(cgpa);
			frc.ArrStu.get(index).acinfo.setClassroom(classroom);
			frc.ArrStu.get(index).acinfo.setSemester(semester);
			frc.ArrStu.get(index).acinfo.setSession(session);
			frc.ArrStu.get(index).acinfo.setYear(year);
			frc.ArrStu.get(index).psinfo.setDOB(DOB);
			frc.ArrStu.get(index).psinfo.setFN(FN);
			frc.ArrStu.get(index).psinfo.setHomeTown(hometown);
			frc.ArrStu.get(index).psinfo.setMN(MN);
			frc.ArrStu.get(index).psinfo.setName(name);
